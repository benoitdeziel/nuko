...
import { command, commandDialog, styled } from '@nuko/styled-system';
...
export const CommandEmpty = withContext(
  styled(CommandPrimitive.Empty),
  'empty',
);
export const CommandGroup = withContext(
  styled(CommandPrimitive.Group),
  'group',
);
export const CommandSeparator = withContext(
  styled(CommandPrimitive.Separator),
  'separator',
);
