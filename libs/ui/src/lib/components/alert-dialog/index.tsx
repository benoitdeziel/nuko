...
import { alertDialog, button, cx, styled } from '@nuko/styled-system';

const { withProvider, withContext } = createStyleContext(alertDialog);

const AlertDialogPortal = withContext(
  styled(AlertDialogPrimitive.Portal),
  'portal',
);
const AlertDialogOverlay = withContext(
...
export const AlertDialog = withProvider(
  styled(AlertDialogPrimitive.Root),
  'root',
);
export const AlertDialogTrigger = withContext(
...
export const AlertDialogTitle = withContext(
...
export const AlertDialogAction = withContext(
  styled(AlertDialogPrimitive.Action, button),
  'action',
);
